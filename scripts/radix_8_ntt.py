...
def r8ntt(a, N = N, Q = Q, PSI = find_2nth_rou(Q, N)):
...
def r8inttopt(a):
    ...
    for p in range(N//8):
        ...
        for i in range(N//8):
            ...
            a0a4p, a0a4n = a[i + 0*N//8] + a[i + 1*N//2], a[i + 0*N//8] - a[i + 1*N//2]
            a2a6p, a2a6n = a[i + 2*N//8] + a[i + 6*N//8], (a[i + 2*N//8] - a[i + 6*N//8]) << 8
            a1a5p, a1a5n = a[i + 1*N//8] + a[i + 5*N//8], (a[i + 1*N//8] - a[i + 5*N//8]) << 4
            a3a7p, a3a7n = a[i + 3*N//8] + a[i + 7*N//8], (a[i + 3*N//8] - a[i + 7*N//8]) << 12

            a0a4pa2a6pp, a0a4pa2a6pn = a0a4p + a2a6p, a0a4p - a2a6p
            a0a4na2a6np, a0a4na2a6nn = a0a4n + a2a6n, a0a4n - a2a6n

            a1a5pa3a7pp = a1a5p + a3a7p
            a1a5pa3a7pn = (a1a5p - a3a7p) << 8
            a1a5na3a7np = a1a5n + a3a7n
            a1a5na3a7nn = (a1a5n - a3a7n) << 8
...
a = r8nttopt([1 for i in range(N)])
b = r8inttopt(r8nttopt([1 for i in range(N)]))
print(a)
